...
<div class="menu-search">
    ...
    <div class="layui-inline">
        ...
        <div class="layui-input-inline">
            <?= Html::dropDownList('CouponActivitySearch[status]', Yii::$app->request->get('CouponActivitySearch')['status']??4, ['0'=>'未启用', '1'=>'待生效', '4'=>'生效中', '5'=>'已过期', '2'=>'已取消'], ['id' => 'activity-status', 'prompt' => '全部'])?>
        </div>
    </div>
