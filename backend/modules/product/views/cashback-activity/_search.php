...
<div class="menu-search">
    ...
    <div class="layui-inline">
        ...
        <div class="layui-input-inline">
            <?= Html::dropDownList('CashbackActivitySearch[status]', Yii::$app->request->get('CashbackActivitySearch')['status']??4, ['0'=>'未启用', '1'=>'待生效', '4'=>'生效中', '5'=>'已过期', '2'=>'已取消'], ['id' => 'activity-status', 'prompt' => '全部'])?>
        </div>
    </div>
    <span class="help-block" style="display: inline-block;"></span>
