...
<blockquote class="layui-elem-quote" style="font-size: 14px;">
    <?php  echo $this->render('_basicsearch', ['model' => $searchModel]); ?>
</blockquote>
            ...
            [
                ...
                'buttons' => [
                    ...
                    'update' => function ($url, $model, $key) {
                        return Html::a('修改', Url::to(['updatebasic','id'=>$model->id]), ['class' => "layui-btn layui-btn-normal layui-btn-xs layui-default-update"]);
                    },
