...
<div class="user-form create_box">
	...
	<?= $form->field($model, 'firstname')->textInput(['maxlength' => true,'class'=>'layui-input']) ?>
    <?= $form->field($model, 'lastname')->textInput(['maxlength' => true,'class'=>'layui-input']) ?>
    ...
    <?= $form->field($model, 'email')->textInput(['maxlength' => true,'class'=>'layui-input','readonly'=>'true']) ?>
