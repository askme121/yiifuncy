            ...
            <div id="account-tab-content" class="tab-content">
                <div class="tab-pane fade in active" id="details">
                    ...
                    <div class="row detail-review-container">
                        <div class="col-xs-12 col-sm-6 col-lg-6 pd0 share-view-left">
                            <p class="detail-review-title" style="margin-left: 30px;">Amazon Order Info</p>
                        ...
                        <div class="col-xs-12 col-sm-6 col-lg-6 pd0 share-view-right">
                            <?php if ($order['order_type'] != 2 && $order['coupon_code']){?>
                            <p class="detail-review-title">Code</p>
                            <p>
